...
function printHelp() {
  console.log(
    [
      ...
      "  CLAWTY_INDEX_FRESHNESS_ENABLED Optional (default: true)",
      "  CLAWTY_INDEX_FRESHNESS_STALE_AFTER_MS Optional (default: 300000)",
      "  CLAWTY_INDEX_FRESHNESS_WEIGHT Optional (default: 0.12)",
      "  CLAWTY_INDEX_FRESHNESS_VECTOR_STALE_PENALTY Optional (default: 0.25)",
      "  CLAWTY_INDEX_FRESHNESS_MAX_PATHS Optional (default: 200)",
      "  CLAWTY_AGENT_INCREMENTAL_CONTEXT_ENABLED Optional (default: true)",
      "  CLAWTY_AGENT_INCREMENTAL_CONTEXT_MAX_PATHS Optional (default: 40)",
      "  CLAWTY_AGENT_INCREMENTAL_CONTEXT_MAX_DIFF_CHARS Optional (default: 12000)",
      ...
      "  CLAWTY_WATCH_DEBOUNCE_MS Optional (default: 500)",
      "  CLAWTY_WATCH_HASH_SKIP_ENABLED Optional (default: true)",
      "  CLAWTY_WATCH_HASH_INIT_MAX_FILES Optional (default: 2000)",
...
function printWatchHelp() {
  console.log(
    [
      ...
      "  --debounce-ms <n>                Delay before queue flush when events keep arriving",
      "  --build-on-start <bool>          Build indexes once before watch loop",
      "  --no-build-on-start              Disable initial build",
      "  --hash-skip-enabled <bool>       Skip changed paths when content hash is unchanged",
      "  --hash-init-max-files <n>        Max files hashed during watch startup seed",
      "  --no-hash-skip                   Disable content-hash skip optimization",
      ...
      "  CLAWTY_WATCH_DEBOUNCE_MS",
      "  CLAWTY_WATCH_HASH_SKIP_ENABLED",
      "  CLAWTY_WATCH_HASH_INIT_MAX_FILES",
